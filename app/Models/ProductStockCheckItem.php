...
class ProductStockCheckItem extends Model
{
    use HasFactory;

    protected $fillable = [
        'product_stock_check_id', 'product_id', 'system_qty', 'physical_qty',
    ...
    public function productStockCheck(): BelongsTo
    {
        return $this->belongsTo(ProductStockCheck::class);
    }
